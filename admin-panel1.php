          ...
          <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="special" class="form-control" id="special" required="required">
                      ...
                      <option value="Pediatrician" name="spec">ENT</option>
                      <option value="Pediatrician" name="spec">Psychiatrist</option>
                      <option value="Pediatrician" name="spec">Orthopaedics</option>
                      <option value="Pediatrician" name="spec">Dermatologist</option>
                      <option value="Pediatrician" name="spec">Gyaenecologist</option>
                      <option value="Pediatrician" name="spec">Gastroentrologist</option>
                      <option value="Pediatrician" name="spec">Nephrologist</option>
