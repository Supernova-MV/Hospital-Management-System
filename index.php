    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <li class="nav-item" style="margin-right: 40px;">
          ...
          <li class="nav-item" style="margin-right: 40px;">
            <a class="nav-link js-scroll-trigger" href="index.php" style="color: white;font-family: 'IBM Plex Sans', sans-serif;"><h6>LOBBY</h6></a>
          </li>
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="https://i.pinimg.com/originals/7e/51/93/7e5193df38f36e9ee2e3f9f6b51a54f5.jpg" alt=""/>
                        <h3>Welcome</h3>
